...
declare module wijmo.chart {
    ...
    */
    class FlexChartCore extends FlexChartBase {
        ...
        */
        public plotAreas : PlotAreaCollection;
        /**
        ...
        */
        ...
        public _hitTestLabels(pt: Point): _IHitArea;
...
declare module wijmo.chart {
    ...
    */
    class Axis implements _IAxis {
        ...
        */
        public actualMin : any;
        /**
        * Gets the actual axis maximum.
        *
        * It returns a number or a Date object (for time-based data).
        */
        public actualMax : any;
        /**
        ...
        */
        ...
        public _isOverlapped(engine: IRenderEngine, w: number, lblClass: string): boolean;
        public _actualAngle: number;
        /**
        ...
        */
        public _getHeight(engine: IRenderEngine, maxw: number): number;
        public _updateAutoFormat(delta: number): number;
        /**
        ...
        */
        public _render(engine: IRenderEngine): void;
        public _xCross(x: number): boolean;
        public _createMinors(engine: IRenderEngine, vals: number[], isVert: boolean, isNear: boolean, isCategory: boolean): void;
        ...
        public _customConvert: Function;
        public _customConvertBack: Function;
        /**
        ...
        */
        public convert(val: number, maxValue?: number, minValue?: number): number;
        /**
        ...
        */
        ...
        public _getMinNum(): number;
        public _getMaxNum(): number;
        private _invalidate();
        private _cvCollectionChanged(sender, e);
    ...
    */
    class PlotArea {
        ...
        */
        ...
        private _invalidate();
        public _render(engine: IRenderEngine): void;
        public _setPlotX(x: number, w: number): void;
        public _setPlotY(y: number, h: number): void;
    }
    /**
    * Represents a collection of @see:PlotArea objects in a @see:FlexChartCore control.
    */
    class PlotAreaCollection extends collections.ObservableArray {
        /**
        ...
        * @return The axis object with the specified name, or null if not found.
        */
        public getPlotArea(name: string): PlotArea;
        /**
        ...
        */
        public indexOf(name: string): number;
        public _getWidth(column: number): any;
        public _getHeight(row: number): any;
        public _calculateWidths(width: number, ncols: number): number[];
        public _calculateHeights(height: number, nrows: number): number[];
    ...
    */
    class SeriesBase implements _ISeries {
        ...
        */
        ...
        public _measureLegendItem(engine: IRenderEngine, text: string): Size;
        public _drawLegendItem(engine: IRenderEngine, rect: Rect, chartType: ChartType, text: string, style: any, symbolStyle: any): void;
        private _cvCollectionChanged(sender, e);
        private _cvCurrentChanged(sender, e);
        ...
        public _getAltSymbolStroke(seriesIndex?: number): string;
        public _getAltSymbolFill(seriesIndex?: number): string;
    }
}
...
declare module wijmo.chart {
    ...
    */
    class Legend {
        ...
        */
        public position : Position;
        public _getDesiredSize(engine: IRenderEngine, pos: Position, w: number, h: number): Size;
        ...
        public _getPosition(w: number, h: number): Position;
        public _render(engine: IRenderEngine, pt: Point, pos: Position, w: number, h: number): any;
    ...
    */
    class HitTestInfo {
        ...
        */
        ...
        public _xfmt : any;
        public _yfmt : any;
        public _setData(series: SeriesBase, pi?: number): void;
        public _setDataPoint(dataPoint: _DataPoint): void;
...
declare module wijmo.chart {
    ...
    */
    class DataLabelBase {
        ...
        */
        public onRendering(e: DataLabelRenderEventArgs): boolean;
        public _invalidate(): void;
    }
    /**
...
declare module wijmo.chart {
    class _FinancePlotter extends _BasePlotter {
        ...
        public isArms: boolean;
        public isEqui: boolean;
        public isVolume: boolean;
        public symbolWidth: any;
        private _volHelper;
        private _itemsSource;
        private _symWidth;
        private _isPixel;
        ...
        public load(): void;
        public unload(): void;
        public parseSymbolWidth(val: any): void;
        public adjustLimits(dataInfo: _DataInfo, plotRect: Rect): Rect;
        public plotSeries(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, series: _ISeries, palette: _IPalette, iser: number, nser: number): void;
...
declare module wijmo.chart {
    class _VolumeHelper {
        ...
        public convert(x: number, min: number, max: number): number;
        public convertBack(x: number, min: number, max: number): number;
        private _init();
