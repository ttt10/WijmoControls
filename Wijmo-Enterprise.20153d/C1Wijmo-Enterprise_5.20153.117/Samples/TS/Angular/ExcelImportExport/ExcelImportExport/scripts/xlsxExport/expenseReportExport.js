...
(function (XlsxExport) {
    function exportExpenseReport(employees) {
        ...
        var dateFormat = xcNs.Workbook.toXlsxDateFormat('d'), stdNumWidth = 85, simpleCaptionStyle = new xcNs.WorkbookStyle(), accentCaptionStyle = new xcNs.WorkbookStyle(), totalCaptionStyle = new xcNs.WorkbookStyle(), valueStyle = new xcNs.WorkbookStyle(), highlightedValueStyle = new xcNs.WorkbookStyle(), tableHeaderStyle = new xcNs.WorkbookStyle(), tableFooterCurrencyStyle = new xcNs.WorkbookStyle(), tableValueStyle = new xcNs.WorkbookStyle(), tableDateStyle = new xcNs.WorkbookStyle(), tableCurrencyStyle = new xcNs.WorkbookStyle(), tableIntegerStyle = new xcNs.WorkbookStyle();

        simpleCaptionStyle.hAlign = 3 /* Right */;
        ...
        totalCaptionStyle.hAlign = 3 /* Right */;
        ...
        tableFooterCurrencyStyle.hAlign = 3 /* Right */;
        ...
        for (var emplIdx = 0; emplIdx < employees.length; emplIdx++) {
            ...
            for (var i = 0; i < expenses.length; i++) {
                ...
                rows[rowIdx].cells[10].formula = 'SUM(' + xcNs.Workbook.xlsxAddress(rowIdx, 3) + ':' + xcNs.Workbook.xlsxAddress(rowIdx, 7) + ')+' + xcNs.Workbook.xlsxAddress(rowIdx, 8) + '*' + xcNs.Workbook.xlsxAddress(rowIdx, 9);
            ...
            rows[totalIdx].cells[8].formula = 'SUMPRODUCT(' + xcNs.Workbook.xlsxAddress(firstIdx, 7) + ':' + xcNs.Workbook.xlsxAddress(totalIdx - 1, 7) + ',' + xcNs.Workbook.xlsxAddress(firstIdx, 8) + ':' + xcNs.Workbook.xlsxAddress(totalIdx - 1, 8) + ')';
