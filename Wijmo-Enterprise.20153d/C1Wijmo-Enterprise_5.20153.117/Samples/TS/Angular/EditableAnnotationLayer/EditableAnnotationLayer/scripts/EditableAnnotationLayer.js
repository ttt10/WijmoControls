            ...
            */
            var EditableAnnotationLayer = (function (_super) {
                ...
                */
                ...
                EditableAnnotationLayer.prototype._showTooltip = function () {
                    return _super.prototype._showTooltip.call(this) && !this._isDragging;
                };
                ...
                EditableAnnotationLayer.prototype._onHostMouseDown = function (e) {
                    var self = this, rootEle = self._chart.hostElement, anno, pt = e instanceof MouseEvent ? new wijmo.Point(e.pageX, e.pageY) : new wijmo.Point(e.changedTouches[0].pageX, e.changedTouches[0].pageY), pNode, del, btn, hostRect, plotRect = self._chart._plotRect, isDC = self._isDataCoordinate, textEditor = self._textEditor, dp;
