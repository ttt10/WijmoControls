...
declare module wijmo {
    ...
    */
    function hasItems(value: collections.ICollectionView): number;
    /**
    ...
    */
    function enable(e: HTMLElement, enable: boolean): void;
    /**
    ...
    */
    class CollectionView implements IEditableCollectionView, IPagedCollectionView {
        ...
        */
        ...
        public _performSort(items: any[]): void;
        public _compareItems(): (a: any, b: any) => number;
        public _performFilter(items: any[]): any[];
        /**
        * Occurs after the current item changes.
        */
        ...
        */
        public _trackItemChanged(item: any): void;
        /**
        * Ends the current add transaction and saves the pending new item.
        */
    ...
    */
    class Color {
        ...
        */
        ...
        public _parse(c: string): boolean;
        /**
...
declare module wijmo {
    ...
    */
    function showPopup(popup: HTMLElement, ref?: any, above?: boolean, fadeIn?: boolean, copyStyles?: boolean): void;
    /**
...
declare module wijmo {
    ...
    */
    class _MaskProvider {
        ...
        public _spellCheck: boolean;
        public _hbInput: any;
        public _hbKeyDown: any;
        public _hbKeyPress: any;
        public _hbCompositionStart: any;
        public _hbCompositionEnd: any;
        ...
        */
        ...
        public _compositionstart(e: KeyboardEvent): void;
        public _compositionend(e: KeyboardEvent): void;
        public _preventKey(charCode: number): boolean;
        public _connect(connect: boolean): void;
        public _valueChanged(): void;
        public _applyMask(): string;
        public _handleVagueLiterals(text: string): string;
