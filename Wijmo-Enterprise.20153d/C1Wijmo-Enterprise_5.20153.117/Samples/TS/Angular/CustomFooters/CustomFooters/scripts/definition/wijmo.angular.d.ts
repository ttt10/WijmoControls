...
declare module wijmo.angular {
    class MetaFactory extends interop.ControlMetaFactory {
        static CreateProp(propertyName: string, propertyType: interop.PropertyType, changeEvent?: string, enumType?: any, isNativeControlProperty?: boolean, priority?: number): PropDesc;
    ...
    class PropDesc extends interop.PropDescBase {
        ...
        constructor(propertyName: string, propertyType: interop.PropertyType, changeEvent?: string, enumType?: any, isNativeControlProperty?: boolean, priority?: number);
        public scopeBindingMode : string;
        public customHandler : (scope: ng.IScope, control: Control, value: any, oldValue: any, link: WjLink) => any;
    }
