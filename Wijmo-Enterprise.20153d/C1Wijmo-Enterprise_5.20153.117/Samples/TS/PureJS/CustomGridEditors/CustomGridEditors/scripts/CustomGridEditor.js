var CustomGridEditor = (function () {
    ...
    */
    function CustomGridEditor(flex, binding, edtClass, options) {
        ...
        // create editor and its host element
        this._edt = document.createElement('div');
        this._ctl = new edtClass(this._edt, options);
        ...
        this._grid.addEventListener(this._grid.hostElement, 'keydown', function (e) {
            ...
            if (e.keyCode == 115 /* F4 */ || (e.altKey && (e.keyCode == 40 /* Down */ || e.keyCode == 38 /* Up */))) {
    ...
    CustomGridEditor.prototype._closeEditor = function (saveEdits) {
        ...
        var p = this._edt.parentElement, grid = this._grid, edt = wijmo.Control.getControl(this._edt);
        if (p) {
