...
declare module wijmo.chart.finance {
    ...
    */
    class FinancialChart extends FlexChartCore {
        ...
        */
        public chartType : FinancialChartType;
        /**
        ...
        */
        public options : any;
        private _heikinAshiPlotter;
        private _lineBreakPlotter;
        private _renkoPlotter;
        private _kagiPlotter;
        public _getChartType(): ChartType;
        public _getPlotter(series: FinancialSeries): _IPlotter;
...
declare module wijmo.chart.finance {
    ...
    class _HeikinAshiCalculator extends _BaseCalculator {
        constructor(highs: number[], lows: number[], opens: number[], closes: number[]);
        public calculate(): _IFinanceItem[];
    }
    class _BaseRangeCalculator extends _BaseCalculator {
        public xs: number[];
        public size: number;
        public unit: RangeMode;
    ...
    class _RenkoCalculator extends _BaseRangeCalculator {
        ...
        public calculate(): _IFinanceItem[];
        public _round(value: number, size: number): number;
    }
}
...
declare module wijmo.chart.finance {
    class _HeikinAshiPlotter extends _FinancePlotter {
        ...
        constructor();
        public clear(): void;
        public plotSeries(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, series: FinancialSeries, palette: _IPalette, iser: number, nser: number): void;
        public _drawSymbol(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, si: number, pi: number, fill: any, w: number, x: number, hi: number, lo: number, open: number, close: number, dpt?: _DataPoint, dt?: DataType): void;
        public _getDataPoint(seriesIndex: number, pointIndex: number, x: any, series: SeriesBase): _DataPoint;
...
declare module wijmo.chart.finance {
    class _BaseRangePlotter extends _BasePlotter {
        private _symFactor;
        public _calculator: _BaseRangeCalculator;
        public _rangeValues: _IFinanceItem[];
        public _rangeXLabels: any[];
        constructor();
        public clear(): void;
        public unload(): void;
        public adjustLimits(dataInfo: _DataInfo, plotRect: Rect): Rect;
        public plotSeries(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, series: FinancialSeries, palette: _IPalette, iser: number, nser: number): void;
        public _drawSymbol(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, si: number, pi: number, w: number, x: number, start: number, end: number, dpt: _DataPoint): void;
        public _getDataPoint(seriesIndex: number, pointIndex: number, series: SeriesBase, dataY: number): _DataPoint;
        public _init(): void;
        public _calculate(series: FinancialSeries): void;
        public _generateXLabels(series: FinancialSeries): void;
        public getOption(name: string, parent?: string): any;
    }
    /**
