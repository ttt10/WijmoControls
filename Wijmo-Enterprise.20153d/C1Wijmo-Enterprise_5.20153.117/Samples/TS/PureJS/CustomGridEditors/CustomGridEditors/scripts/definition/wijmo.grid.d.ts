...
declare module wijmo.grid {
    ...
    */
    class FlexGrid extends Control {
        ...
        * changes to the CSS.
        */
        public showAlternatingRows : boolean;
        /**
        ...
        */
        public getMergedRange(p: GridPanel, r: number, c: number, clip?: boolean): CellRange;
        /**
        ...
        */
        public onScrollPositionChanged(e?: EventArgs): void;
        /**
        ...
        * @return True if the event was not canceled.
        */
        public onPastingCell(e: CellRangeEventArgs): boolean;
        /**
        * Occurs after the user has pasted content from the
        * clipboard into a cell (see the @see:autoClipboard property).
        */
        public pastedCell: Event;
        /**
        * Raises the @see:pastedCell event.
        *
        * @param e @see:CellRangeEventArgs that contains the event data.
        */
        public onPastedCell(e: CellRangeEventArgs): void;
        /**
        ...
        * </ul>
        */
        public updatedView: Event;
        /**
        * Raises the @see:updatedView event.
        */
        public onUpdatedView(e?: EventArgs): void;
        public _getCollectionView(value: any): collections.ICollectionView;
        ...
        public _updateStickyHeaders(): void;
        private _updateScrollPosition();
        private _updateContent(recycle, state?);
        private _getMarqueeRect(rng);
        public _bindColumns(): void;
        public _updateColumnTypes(): void;
        public _getBindingColumn(p: GridPanel, r: Number, c: Column): Column;
        public _bindRows(): void;
        private _addGroup(g);
...
declare module wijmo.grid {
    ...
    */
    class GridPanel {
        ...
        * @param formatted Whether to format the value for display.
        */
        public getCellData(r: number, c: any, formatted: boolean): any;
        /**
...
declare module wijmo.grid {
    ...
    */
    class CellFactory {
        ...
        */
        public updateCell(p: GridPanel, r: number, c: number, cell: HTMLElement, rng?: CellRange, updateContent?: boolean): void;
        /**
        * Disposes of a cell element and releases all resources associated with it.
        *
        * @param cell The element that represents the cell.
        */
        public disposeCell(cell: HTMLElement): void;
...
declare module wijmo.grid {
    ...
    */
    class CellRange {
        ...
        * @param c2 The index of the first column in the range (defaults to @see:r).
        */
        public setRange(r?: number, c?: number, r2?: number, c2?: number): void;
        /**
        ...
        * @param rng The CellRange object to check.
        */
        public intersectsRow(rng: CellRange): boolean;
        /**
        * Checks whether the range intersects the columns in another range.
        *
        * @param rng The CellRange object to check.
        */
        public intersectsColumn(rng: CellRange): boolean;
        /**
        ...
        */
        public getRenderSize(p: GridPanel): Size;
        /**
...
declare module wijmo.grid {
    ...
    */
    class MergeManager {
        ...
        */
        public getMergedRange(p: GridPanel, r: number, c: number, clip?: boolean): CellRange;
        public _mergeCell(p: GridPanel, r1: number, c1: number, r2: number, c2: number): boolean;
    }
}
    ...
    */
    class _SelectionHandler {
        ...
        */
        ...
        public _adjustSelection(rng: CellRange): CellRange;
    }
}
    ...
    */
    class _EditHandler {
        ...
        */
        ...
        public _commitRowEdits(): void;
        public _blur(): void;
        public _keydown(e: KeyboardEvent): boolean;
        public _keydownListBox(e: KeyboardEvent): boolean;
        public _keypress(e: KeyboardEvent): void;
        public _toggleListBox(rng: CellRange): boolean;
...
declare module wijmo.grid {
    ...
    */
    class _ImeHandler {
        ...
        */
        public dispose(): void;
        public _cellEditEnded(): void;
        public _compositionstart(): void;
        public _updateImeFocus(): void;
        public _enableIme(): boolean;
    }
}
