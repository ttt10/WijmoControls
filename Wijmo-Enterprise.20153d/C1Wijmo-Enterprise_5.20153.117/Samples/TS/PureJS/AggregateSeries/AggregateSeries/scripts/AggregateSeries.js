...
(function (wijmo) {
    (function (chart) {
        (function (research) {
            ...
            var AggregateSeries = (function (_super) {
                    ...
                    set: function (value) {
                        ...
                        if (this._autoGroupIntervals !== value) {
                            ...
                            value.forEach(function (val) {
                                return wijmo.assert(_this._isValidInterval(wijmo.asString(val, false)), "Invalid autoGroupIntervals");
                            }, this);
                ...
                AggregateSeries.prototype._updateAxes = function (subset) {
                    ...
                    values = subset ? this._getValuesInXRange(this._allValues[this._currentInterval], this.bindingX, xmin, xmax) : this._allValues[this._currentInterval];
                ...
                AggregateSeries.prototype._getGroupDescription = function (bindingX, interval, subInterval) {
                    if (typeof subInterval === "undefined") { subInterval = 1; }
                    var fn = null;
                ...
                AggregateSeries.prototype._canGroup = function () {
                    var retval = wijmo.isString(this.binding) && wijmo.isString(this.bindingX) && this.groupAggregate !== 0 /* None */ && this.collectionView !== null && !wijmo.isUndefined(this.collectionView);
        ...
        })(chart.research || (chart.research = {}));
        var research = chart.research;
