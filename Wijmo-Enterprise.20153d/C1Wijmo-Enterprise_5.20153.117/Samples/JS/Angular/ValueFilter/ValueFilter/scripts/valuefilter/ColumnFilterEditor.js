            ...
            */
            var ColumnFilterEditor = (function (_super) {
                ...
                */
                ...
                ColumnFilterEditor.controlTemplate = '<div style="padding:6px;min-width:250px">' + '<a wj-part="btn-asc" href="" style="min-width:95px">&#8593; Ascending</a>&nbsp;&nbsp;&nbsp;' + '<a wj-part="btn-dsc" href="" style="min-width:95px">&#8595; Descending</a>' + '<br/>' + '<br/>' + '<div wj-part="div-filter" style="width:100%"></div>' + '<br/>' + '<label class="wj-listbox-item"><input type="checkbox" wj-part="cb-select-all"> Select All</label>' + '<div wj-part="div-values" class="wj-dropdown" style="height:150px;width:100%;margin:0px"></div>' + '<br/>' + '<div style="text-align:right;margin-top:6px">' + '<a wj-part="btn-apply" href="">Apply</a>&nbsp;&nbsp;&nbsp;' + '<a wj-part="btn-clear" href="">Clear</a>' + '</div>';
