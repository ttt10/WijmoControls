                ...
                switch (metaDataId) {
                    ...
                    case wijmo.input && wijmo.input.DropDown:
                        return this.getMetaData(wijmo.Control).add([
                            this.CreateProp('isDroppedDown', 0 /* Boolean */, 'isDroppedDownChanged'),
                            this.CreateProp('showDropDownButton', 0 /* Boolean */),
                            this.CreateProp('autoExpandSelection', 0 /* Boolean */),
                            this.CreateProp('placeholder', 3 /* String */),
                            this.CreateProp('dropDownCssClass', 3 /* String */),
                            this.CreateProp('text', 3 /* String */, 'textChanged', null, true, 1000)
                        ], [
                    ...
                    case wijmo.input && wijmo.input.ComboBox:
                        return this.getMetaData(wijmo.input.DropDown).add([
                            ...
                            this.CreateProp('headerPath', 3 /* String */),
                            ...
                            this.CreateProp('itemsSource', 8 /* Any */, '', null, true, 900),
                            this.CreateProp('selectedIndex', 1 /* Number */, 'selectedIndexChanged', null, true, 1000),
                            this.CreateProp('selectedItem', 8 /* Any */, 'selectedIndexChanged', null, true, 1000),
                            this.CreateProp('selectedValue', 8 /* Any */, 'selectedIndexChanged', null, true, 1000)
                        ], [
                    ...
                    case wijmo.input && wijmo.input.Calendar:
                        return this.getMetaData(wijmo.Control).add([
                            ...
                            this.CreateProp('displayMonth', 2 /* Date */, 'displayMonthChanged'),
                            this.CreateProp('firstDayOfWeek', 1 /* Number */),
                            this.CreateProp('max', 2 /* Date */),
                            this.CreateProp('min', 2 /* Date */),
                            this.CreateProp('value', 2 /* Date */, 'valueChanged')
                        ], [
                    ...
                    case wijmo.input && wijmo.input.ColorPicker:
                        return this.getMetaData(wijmo.Control).add([
                            ...
                            this.CreateProp('value', 3 /* String */, 'valueChanged')
                        ], [
                            this.CreateEvent('valueChanged', true)
                        ]).addOptions({ ngModelProperty: 'value' });
                    ...
                    case wijmo.input && wijmo.input.ListBox:
                        return this.getMetaData(wijmo.Control).add([
                            ...
                            this.CreateProp('selectedIndex', 1 /* Number */, 'selectedIndexChanged'),
                            this.CreateProp('selectedItem', 8 /* Any */, 'selectedIndexChanged'),
                            this.CreateProp('selectedValue', 8 /* Any */, 'selectedIndexChanged')
                        ], [
                            this.CreateEvent('formatItem', false),
                    ...
                    case wijmo.input && wijmo.input.Menu:
                        return this.getMetaData(wijmo.input.ComboBox).add([
                            ...
                            this.CreateProp('value', 8 /* Any */, 'selectedIndexChanged', null, false, 1000)
                        ], [
                    ...
                    case 'MenuItem':
                        return new MetaDataBase([
                            this.CreateProp('value', 8 /* Any */, ''),
                            this.CreateProp('cmd', 8 /* Any */, ''),
                            this.CreateProp('cmdParam', 8 /* Any */, '')
                        ], [], [], 'itemsSource', true);
                    case 'MenuSeparator':
                    ...
                    case wijmo.input && wijmo.input.InputDate:
                        return this.getMetaData(wijmo.input.DropDown).add([
                            ...
                            this.CreateProp('value', 2 /* Date */, 'valueChanged', null, true, 1000),
                            this.CreateProp('itemValidator', 6 /* Function */),
                            this.CreateProp('itemFormatter', 6 /* Function */)
                        ], [
                            this.CreateEvent('valueChanged', true)
                    ...
                    case wijmo.input && wijmo.input.InputDateTime:
                        return this.getMetaData(wijmo.input.InputDate).add([
                            this.CreateProp('timeMax', 2 /* Date */),
                            this.CreateProp('timeMin', 2 /* Date */),
                            this.CreateProp('timeStep', 1 /* Number */),
                            this.CreateProp('timeFormat', 3 /* String */)
                        ], [
                            this.CreateEvent('valueChanged', true)
                        ]).addOptions({ ngModelProperty: 'value' });
                    ...
                    case wijmo.input && wijmo.input.InputNumber:
                        return this.getMetaData(wijmo.Control).add([
                            ...
                            this.CreateProp('placeholder', 3 /* String */),
                            this.CreateProp('inputType', 3 /* String */),
                            this.CreateProp('value', 1 /* Number */, 'valueChanged'),
                            this.CreateProp('text', 3 /* String */, 'textChanged'),
                            this.CreateProp('format', 3 /* String */)
                        ], [
                            this.CreateEvent('valueChanged', true),
                            this.CreateEvent('textChanged', true)
                    ...
                    case wijmo.input && wijmo.input.InputMask:
                        return this.getMetaData(wijmo.Control).add([
                            ...
                            this.CreateProp('placeholder', 3 /* String */),
                            this.CreateProp('rawValue', 3 /* String */, 'valueChanged'),
                            this.CreateProp('value', 3 /* String */, 'valueChanged')
                        ], [
                            this.CreateEvent('valueChanged', true)
                        ]).addOptions({ ngModelProperty: 'value' });
                    ...
                    case wijmo.input && wijmo.input.Popup:
                        return this.getMetaData(wijmo.Control).add([
                            ...
                            this.CreateProp('showTrigger', 5 /* Enum */, '', wijmo.input.PopupTrigger),
                            this.CreateProp('hideTrigger', 5 /* Enum */, '', wijmo.input.PopupTrigger),
                    ...
                    case wijmo.grid && wijmo.grid.FlexGrid:
                        return this.getMetaData(wijmo.Control).add([
                            ...
                            this.CreateProp('allowDragging', 5 /* Enum */, '', wijmo.grid.AllowDragging),
                            this.CreateProp('allowMerging', 5 /* Enum */, '', wijmo.grid.AllowMerging),
                            this.CreateProp('allowResizing', 5 /* Enum */, '', wijmo.grid.AllowResizing),
                            this.CreateProp('allowSorting', 0 /* Boolean */),
                            this.CreateProp('autoSizeMode', 5 /* Enum */, '', wijmo.grid.AutoSizeMode),
                            ...
                            this.CreateProp('headersVisibility', 5 /* Enum */, '', wijmo.grid.HeadersVisibility),
                            this.CreateProp('showSelectedHeaders', 5 /* Enum */, '', wijmo.grid.HeadersVisibility),
                            this.CreateProp('showMarquee', 0 /* Boolean */),
                            this.CreateProp('itemFormatter', 6 /* Function */),
                            this.CreateProp('isReadOnly', 0 /* Boolean */),
                            this.CreateProp('imeEnabled', 0 /* Boolean */),
                            this.CreateProp('mergeManager', 8 /* Any */),
                            this.CreateProp('selectionMode', 5 /* Enum */, '', wijmo.grid.SelectionMode),
                            this.CreateProp('showGroups', 0 /* Boolean */),
                            this.CreateProp('showSort', 0 /* Boolean */),
                            this.CreateProp('showAlternatingRows', 0 /* Boolean */),
                            ...
                            this.CreateProp('stickyHeaders', 0 /* Boolean */)
                        ], [
                    ...
                    case wijmo.grid && wijmo.grid.Column:
                        return new MetaDataBase([
                            ...
                            this.CreateProp('dataType', 5 /* Enum */, '', wijmo.DataType),
                            ...
                            this.CreateProp('aggregate', 5 /* Enum */, '', wijmo.Aggregate),
                            this.CreateProp('isReadOnly', 0 /* Boolean */),
                            this.CreateProp('cssClass', 3 /* String */),
                            this.CreateProp('isContentHtml', 0 /* Boolean */),
                            this.CreateProp('isSelected', 0 /* Boolean */, 'grid.selectionChanged'),
                    ...
                    case 'FlexGridCellTemplate':
                        return new MetaDataBase([
                            this.CreateProp('cellType', 3 /* String */, '', null, false),
                            this.CreateProp('cellOverflow', 3 /* String */, '')
                    ...
                    case wijmo.grid && wijmo.grid.filter && wijmo.grid.filter.FlexGridFilter:
                        return new MetaDataBase([
                            ...
                            this.CreateProp('defaultFilterType', 5 /* Enum */, '', wijmo.grid.filter.FilterType),
                    ...
                    case wijmo.grid && wijmo.grid.detail && wijmo.grid.detail.FlexGridDetailProvider:
                        return new MetaDataBase([
                            this.CreateProp('maxHeight', 1 /* Number */),
                            this.CreateProp('detailVisibilityMode', 5 /* Enum */, '', wijmo.grid.detail.DetailVisibilityMode),
                    ...
                    case wijmo.grid && wijmo.grid.sheet && wijmo.grid.sheet.FlexSheet:
                        return this.getMetaData(wijmo.grid.FlexGrid).add([
                            this.CreateProp('isTabHolderVisible', 0 /* Boolean */),
                            this.CreateProp('selectedSheetIndex', 1 /* Number */, 'selectedSheetChanged')
                        ], [
                    ...
                    case wijmo.grid && wijmo.grid.sheet && wijmo.grid.sheet.Sheet:
                        return new wijmo.interop.MetaDataBase([
                            ...
                            this.CreateProp('itemsSource', 8 /* Any */),
                            this.CreateProp('visible', 0 /* Boolean */),
                            this.CreateProp('rowCount', 1 /* Number */, '', null, false),
                            this.CreateProp('columnCount', 1 /* Number */, '', null, false)
                        ], [
                    ...
                    case wijmo.chart && wijmo.chart.FlexChartBase:
                        return this.getMetaData(wijmo.Control).add([
                            ...
                            this.CreateProp('header', 3 /* String */),
                            this.CreateProp('selectionMode', 5 /* Enum */, '', wijmo.chart.SelectionMode),
                            this.CreateProp('palette', 8 /* Any */),
                            this.CreateProp('plotMargin', 8 /* Any */),
                            this.CreateProp('footerStyle', 8 /* Any */),
                            this.CreateProp('headerStyle', 8 /* Any */),
                            this.CreateProp('tooltipContent', 3 /* String */, '', null, false),
                            this.CreateProp('itemsSource', 8 /* Any */)
                        ], [
                    ...
                    case wijmo.chart && wijmo.chart.FlexChartCore:
                        return this.getMetaData(wijmo.chart.FlexChartBase).add([
                            ...
                            this.CreateProp('selection', 8 /* Any */, 'selectionChanged'),
                            this.CreateProp('itemFormatter', 6 /* Function */),
                            this.CreateProp('labelContent', 3 /* String */, '', null, false)
                        ], [
                    ...
                    case wijmo.chart && wijmo.chart.FlexChart:
                        return this.getMetaData(wijmo.chart.FlexChartCore).add([
                            this.CreateProp('chartType', 5 /* Enum */, '', wijmo.chart.ChartType),
                            this.CreateProp('rotated', 0 /* Boolean */),
                            this.CreateProp('stacking', 5 /* Enum */, '', wijmo.chart.Stacking)
                        ]);
                    ...
                    case wijmo.chart && wijmo.chart.FlexPie:
                        return this.getMetaData(wijmo.chart.FlexChartBase).add([
                            ...
                            this.CreateProp('selectedItemPosition', 5 /* Enum */, '', wijmo.chart.Position),
                    ...
                    case wijmo.chart && wijmo.chart.Axis:
                        return new MetaDataBase([
                            ...
                            this.CreateProp('majorTickMarks', 5 /* Enum */, '', wijmo.chart.TickMark),
                            this.CreateProp('majorUnit', 1 /* Number */),
                            this.CreateProp('max', 1 /* Number */),
                            this.CreateProp('min', 1 /* Number */),
                            this.CreateProp('position', 5 /* Enum */, '', wijmo.chart.Position),
                            this.CreateProp('reversed', 0 /* Boolean */),
                            this.CreateProp('title', 3 /* String */),
                            this.CreateProp('labelAngle', 1 /* Number */),
                            this.CreateProp('minorGrid', 0 /* Boolean */),
                            this.CreateProp('minorTickMarks', 5 /* Enum */, '', wijmo.chart.TickMark),
                            this.CreateProp('minorUnit', 1 /* Number */),
                            ...
                            this.CreateProp('name', 3 /* String */),
                            this.CreateProp('overlappingLabels', 5 /* Enum */, '', wijmo.chart.OverlappingLabels),
                            this.CreateProp('labelPadding', 1 /* Number */)
                        ], [], [], 'axes', true);
                    ...
                    case wijmo.chart && wijmo.chart.DataLabel:
                        return this.getMetaData(wijmo.chart.DataLabelBase).add([
                            this.CreateProp('position', 5 /* Enum */, '', wijmo.chart.LabelPosition)
                        ]);

                    case wijmo.chart && wijmo.chart.PieDataLabel:
                        return this.getMetaData(wijmo.chart.DataLabelBase).add([
                            this.CreateProp('position', 5 /* Enum */, '', wijmo.chart.PieLabelPosition)
                        ]);
                    ...
                    case wijmo.chart && wijmo.chart.SeriesBase:
                        return new MetaDataBase([
                            ...
                            this.CreateProp('symbolMarker', 5 /* Enum */, '', wijmo.chart.Marker),
                            this.CreateProp('symbolSize', 1 /* Number */),
                            this.CreateProp('symbolStyle', 8 /* Any */),
                            this.CreateProp('visibility', 5 /* Enum */, 'chart.seriesVisibilityChanged', wijmo.chart.SeriesVisibility),
                            this.CreateProp('itemsSource', 8 /* Any */)
                        ], [], [
                    ...
                    case wijmo.chart && wijmo.chart.LineMarker:
                        return new MetaDataBase([
                            ...
                            this.CreateProp('alignment', 5 /* Enum */, '', wijmo.chart.LineMarkerAlignment),
                            this.CreateProp('lines', 5 /* Enum */, '', wijmo.chart.LineMarkerLines),
                            this.CreateProp('interaction', 5 /* Enum */, '', wijmo.chart.LineMarkerInteraction),
                    ...
                    case 'FlexChartAnnotation':
                        return new MetaDataBase([
                            this.CreateProp('type', 3 /* String */, '', null, false),
                            this.CreateProp('attachment', 5 /* Enum */, '', wijmo.chart.annotation.AnnotationAttachment),
                            this.CreateProp('position', 5 /* Enum */, '', wijmo.chart.annotation.AnnotationPosition),
                    ...
                    case wijmo.chart && wijmo.chart.interaction && wijmo.chart.interaction.RangeSelector:
                        return new MetaDataBase([
                            ...
                            this.CreateProp('min', 1 /* Number */),
                            this.CreateProp('max', 1 /* Number */),
                            this.CreateProp('orientation', 5 /* Enum */, '', wijmo.chart.interaction.Orientation),
                            this.CreateProp('seamless', 0 /* Boolean */),
                            this.CreateProp('minScale', 1 /* Number */),
                            this.CreateProp('maxScale', 1 /* Number */)
                        ], [
                    ...
                    case wijmo.chart && wijmo.chart.finance && wijmo.chart.finance.FinancialChart:
                        return this.getMetaData(wijmo.chart.FlexChartCore).add([
                            this.CreateProp('chartType', 5 /* Enum */, '', wijmo.chart.finance.FinancialChartType)
                        ]);
                    ...
                    case wijmo.chart && wijmo.chart.analytics && wijmo.chart.analytics.TrendLine:
                        return this.getMetaData(wijmo.chart.analytics.TrendLineBase).add([
                            ...
                            this.CreateProp('fitType', 5 /* Enum */, '', wijmo.chart.analytics.TrendLineFitType)
                        ]);

                    case wijmo.chart && wijmo.chart.analytics && wijmo.chart.analytics.MovingAverage:
                        return this.getMetaData(wijmo.chart.analytics.TrendLineBase).add([
                            this.CreateProp('period', 1 /* Number */),
                            this.CreateProp('type', 5 /* Enum */, '', wijmo.chart.analytics.MovingAverageType)
                        ]);
                    ...
                    case wijmo.chart && wijmo.chart.finance && wijmo.chart.finance.analytics && wijmo.chart.finance.analytics.Fibonacci:
                        return this.getMetaData(wijmo.chart.SeriesBase).add([
                            ...
                            this.CreateProp('labelPosition', 5 /* Enum */, '', wijmo.chart.LabelPosition),
                            this.CreateProp('levels', 8 /* Any */),
                    ...
                    case wijmo.chart && wijmo.chart.finance && wijmo.chart.finance.analytics && wijmo.chart.finance.analytics.FibonacciTimeZones:
                        return this.getMetaData(wijmo.chart.SeriesBase).add([
                            this.CreateProp('startX', 8 /* Any */),
                            this.CreateProp('endX', 8 /* Any */),
                            this.CreateProp('labelPosition', 5 /* Enum */, '', wijmo.chart.LabelPosition),
                            this.CreateProp('levels', 8 /* Any */)
                        ]);
                    ...
                    case wijmo.chart && wijmo.chart.finance && wijmo.chart.finance.analytics && wijmo.chart.finance.analytics.MacdBase:
                        return this.getMetaData(wijmo.chart.finance.analytics.OverlayIndicatorBase).add([
                            this.CreateProp('fastPeriod', 1 /* Number */),
                            this.CreateProp('slowPeriod', 1 /* Number */),
                            this.CreateProp('smoothingPeriod', 1 /* Number */)
                        ]);
                    ...
                    case wijmo.chart && wijmo.chart.finance && wijmo.chart.finance.analytics && wijmo.chart.finance.analytics.Envelopes:
                        return this.getMetaData(wijmo.chart.finance.analytics.OverlayIndicatorBase).add([
                            this.CreateProp('period', 1 /* Number */),
                            this.CreateProp('size', 1 /* Number */),
                            this.CreateProp('type', 5 /* Enum */, '', wijmo.chart.finance.analytics.MovingAverageType)
                        ]);

                    case wijmo.chart && wijmo.chart.finance && wijmo.chart.finance.analytics && wijmo.chart.finance.analytics.BollingerBands:
                        return this.getMetaData(wijmo.chart.finance.analytics.OverlayIndicatorBase).add([
                            this.CreateProp('period', 1 /* Number */),
                            this.CreateProp('multiplier', 1 /* Number */)
                        ]);
                    ...
                    case wijmo.gauge && wijmo.gauge.Gauge:
                        return this.getMetaData(wijmo.Control).add([
                            ...
                            this.CreateProp('isAnimated', 0 /* Boolean */),
                            this.CreateProp('showText', 5 /* Enum */, '', wijmo.gauge.ShowText),
                    ...
                    case wijmo.gauge && wijmo.gauge.LinearGauge:
                        return this.getMetaData(wijmo.gauge.Gauge).add([
                            this.CreateProp('direction', 5 /* Enum */, '', wijmo.gauge.GaugeDirection)
                        ]);
        ...
        var PropDescBase = (function () {
            ...
            Object.defineProperty(PropDescBase.prototype, "bindingMode", {
                ...
                get: function () {
                    ...
                    return this.changeEvent ? 1 /* TwoWay */ : 0 /* OneWay */;
                },
                enumerable: true,
                configurable: true
            });
...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        if (wijmo.input && wijmo.input.InputNumber) {
            wijmoInput.directive('wjAutoComplete', [
            ...
            wijmoInput.directive('wjComboBox', [
                '$compile', function ($compile) {
            ...
            wijmoInput.directive('wjInputTime', [
                '$compile', function ($compile) {
            ...
            wijmoInput.directive('wjMultiSelect', [
                '$compile', function ($compile) {
        ...
        var WjMenuLink = (function (_super) {
            ...
            WjMenuLink.prototype._fmtItem = function (s, e) {
                ...
                if (!itemLink.contentLink) {
                    itemLink.contentLink = this.directive._$compile('<div style="display:none">' + itemLink.itemTemplate + '</div>');
                }
                ...
                var clonedElement = itemLink.linkedContent = itemLink.contentLink(itemScope, function (clonedEl, scope) {
                })[0];
                var dispose = itemScope.$watch(function (scope) {
                    dispose();
                    clonedElement.style.display = '';
        ...
        */
        var WjMenuItem = (function (_super) {
            ...
            WjMenuItem._dirictiveId = 'menuItemDir';
            return WjMenuItem;
        })(angular.WjDirective);
        ...
        var WjMenuItemLink = (function (_super) {
            ...
            WjMenuItemLink.prototype._initControl = function () {
                ...
                this.itemTemplate = this.isSeparator ? '<div class="wj-state-disabled" style="width:100%;height:1px;background-color:lightgray"/>' : dynaTempl != null ? dynaTempl : angular.WjDirective._removeTransclude(this.tElement[0].innerHTML);
...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        *   <dt>minScale</dt>      <dd><code>@</code> the valid minimum range of the RangeSelector.</dd>
        *   <dt>maxScale</dt>      <dd><code>@</code> the valid maximum range of the RangeSelector.</dd>
        * </dl>
        */
...
(function (wijmo) {
    ...
    (function (angular) {
        ...
        if (wijmo.grid && wijmo.grid.FlexGrid) {
            ...
            if (wijmo.grid.sheet) {
                wijmoGrid.directive('wjFlexSheet', [
                    '$compile', '$interpolate', function ($compile, $interpolate) {
        ...
        var DirectiveCellFactory = (function (_super) {
            ...
            function DirectiveCellFactory(grid, gridLink) {
                ...
                grid.cellEditEnded.addHandler(function (s, e) {
                    ...
                    if (e.range.col < 0 || !grid.columns[e.range.col][WjFlexGridCellTemplate._getTemplContextProp(1 /* CellEdit */)]) {
                        self._editChar = null;
                    }
                    setTimeout(function () {
                    ...
                    if (col) {
                        ...
                        if (templContext) {
                            ...
                            if (isTpl) {
                                ...
                                if (!cellLink) {
                                    cellLink = templContext.cellLink = this._gridLink.directive._$compile('<div style="display:none"' + (isStyle ? ' ng-style="' + cellStyle + '"' : '') + (isClass ? ' ng-class="' + cellClass + '"' : '') + '>' + tpl + '</div>');
                                ...
                                self._rowHeightUpdates.add({ panel: panel, cell: cell });
                                ...
                                setTimeout(function () {
                                    ...
                                    if (self._updateRowHeight(panel, cell)) {
                                        if (isEdit) {
            ...
            DirectiveCellFactory.prototype._updateRowHeight = function (panel, cell) {
                var cellHeight = cell.scrollHeight, panelRows = panel.rows;
                if (panelRows.defaultSize < cellHeight) {
                    panelRows.defaultSize = cellHeight;
                    return true;
                }
                ...
                while (requests.length > 0) {
                    ...
                    var timeOut = (function (request) {
                        return setTimeout(function () {
                            if (self._cellFactory._updateRowHeight(request.panel, request.cell)) {
                                self.clear();
                            } else {
        ...
        *   <dt>dragging-row-column</dt>    <dd><code>&</code> The @see:draggingRowColumn event handler.</dd>
        *   <dt>dropping-row-column</dt>    <dd><code>&</code> The @see:droppingRowColumn event handler.</dd>
        *   <dt>selected-sheet-changed</dt>    <dd><code>&</code> The @see:selectedSheetChanged event handler.</dd>
        * </dl>
        *
        ...
        */
        ...
        /**
        * AngularJS directive for the @see:FlexSheet @see:Sheet object.
        *
        ...
        *                               Changes to this attribute has no effect after the @see:Sheet was initialized by AngularJS.
        ...
        *   <dt>name-changed</dt>       <dd><code>&</code> The @see:nameChanged event handler.</dd>
        * </dl>
        */
        ...
        var WjSheetLink = (function (_super) {
            ...
            WjSheetLink.prototype._initControl = function () {
                var scope = this.scope, flexSheet = this.parent.control;

                if (scope['itemsSource']) {
                    return flexSheet.addBoundSheet(scope['name'], scope['itemsSource']);
                } else {
                    return flexSheet.addUnboundSheet(scope['name'], +scope['rowCount'], +scope['columnCount']);
                }
            };
            return WjSheetLink;
        })(angular.WjLink);
