            ...
            */
            function DropDown(element, options) {
                ...
                */
                ...
                this.addEventListener(this._dropDown, 'blur', function () {
                ...
                this.addEventListener(this.dropDown, 'focus', function () {
                    _this._updateFocusState();
                });
            ...
            */
            Calendar.prototype.refresh = function (fullUpdate) {
                ...
                for (var i = 7; i < cells.length; i++) {
                    ...
                    wijmo.toggleClass(cell, 'wj-day-othermonth', invalid || day.getMonth() != this.displayMonth.getMonth() || !this._isValidDay(day));
            ...
            */
            function ListBox(element, options) {
                ...
                */
                ...
                this.addEventListener(host, 'onmousewheel' in document ? 'mousewheel' : 'DOMMouseScroll', function (e) {
                    if (host.scrollHeight > host.offsetHeight) {
                        if ((e.wheelDelta > 0 && host.scrollTop == 0) || (e.wheelDelta < 0 && host.scrollTop + host.offsetHeight >= host.scrollHeight)) {
                            e.preventDefault();
                            e.stopPropagation();
                        }
                    }
            ...
            */
            ListBox.prototype.showSelection = function () {
                ...
                if (index > -1 && this.containsFocus()) {
                    e = children[index];
                    if (e instanceof HTMLElement && !wijmo.contains(e, document.activeElement)) {
                        e.focus();
                    }
                }
            };
        ...
        var ComboBox = (function (_super) {
            ...
            */
            ...
            ComboBox.prototype.onIsDroppedDownChanging = function (e) {
                return wijmo.hasItems(this.collectionView) ? _super.prototype.onIsDroppedDownChanging.call(this, e) : false;
            };
            ...
            ComboBox.prototype._setText = function (text, fullMatch) {
                ...
                if (index < 0 && !this.isEditable && wijmo.hasItems(cv) && this._oldText) {
        ...
        var AutoComplete = (function (_super) {
            ...
            */
            function AutoComplete(element, options) {
                ...
                this.required = false; // TFS 142492
            ...
            function Menu(element, options) {
                ...
                */
                ...
                this.addEventListener(this._hdr, 'click', function () {
                    if (_this._isButton) {
                        _this.isDroppedDown = false;
                        _this._raiseCommand(wijmo.EventArgs.empty);
                    } else {
        ...
        var Popup = (function (_super) {
            ...
            */
            function Popup(element, options) {
                ...
                */
                ...
                this.addEventListener(document, 'onmousewheel' in document ? 'mousewheel' : 'DOMMouseScroll', function (e) {
            ...
            Popup.prototype.show = function (modal) {
                ...
                if (!this.isVisible) {
                    ...
                    if (this.onShowing(e)) {
                        ...
                        setTimeout(function () {
                            // if this is not a touch event, set the focus to the first input element on the popup
                            if (!_this.isTouching) {
                                var inputs = _this.hostElement.querySelectorAll('input');
                                for (var i = 0; i < inputs.length; i++) {
                                    var el = inputs[i];
                                    if (!el.disabled && el.tabIndex > -1 && !wijmo.closest(el, '[disabled],.wj-state-disabled')) {
                                        try  {
            ...
            */
            ...
            Popup.prototype.onLostFocus = function (e) {
                ...
                setTimeout(function () {
                    if (!_this.containsFocus()) {
                        if (_this.isVisible && (_this._hideTrigger & 2 /* Blur */)) {
                            _this.hide();
                        }
                    }
                }, 100);
                ...
                */
                ...
                this.addEventListener(this.hostElement, evt, function (e) {
                    if (_this.containsFocus() && !_this.isDroppedDown && !e.defaultPrevented) {
                        if (_this.value != null) {
                            var step = wijmo.clamp(e.wheelDelta || -e.detail, -1, +1);
                            _this.value = wijmo.DateTime.addDays(_this.value, step);
                            _this.selectAll();
                            e.preventDefault();
                        }
                    }
            ...
            */
            ...
            InputDate.prototype._createDropDown = function () {
                ...
                this.addEventListener(this._dropDown, 'mouseup', function () {
                    var value = _this._calendar.value;
...
(function (wijmo) {
    (function (input) {
        ...
        * Use the @see:minTime and @see:maxTime properties to restrict the range of
        ...
        */
        var InputDateTime = (function (_super) {
            ...
            //#region ** ctor
            /**
            * Initializes a new instance of an @see:InputDateTime control.
            *
            * @param element The DOM element that hosts the control, or a selector for the host element (e.g. '#theCtrl').
            * @param options The JavaScript object containing initialization data for the control.
            */
            function InputDateTime(element, options) {
                ...
                var btnTm = this.hostElement.querySelector('[wj-part="btn-tm"]');
                this.addEventListener(btnTm, 'click', this._btnclick.bind(this));
                ...
                this.addEventListener(btnTm, 'mousedown', function (e) {
            ...
            InputDateTime.prototype._updateBtn = function () {
                ...
                var btnTm = this.hostElement.querySelector('[wj-part="btn-tm"]');
                if (btnTm) {
                    btnTm.tabIndex = this._btn.tabIndex;
                    btnTm.style.display = this._btn.style.display;
                }
            };
        ...
        var InputNumber = (function (_super) {
            ...
            */
            function InputNumber(element, options) {
                ...
                */
                ...
                var evt = 'onmousewheel' in document ? 'mousewheel' : 'DOMMouseScroll';
                this.addEventListener(this.hostElement, evt, function (e) {
                    if (_this.containsFocus() && !e.defaultPrevented) {
                        if (_this.value != null) {
                            var step = wijmo.clamp(e.wheelDelta || -e.detail, -1, +1);
                            _this.value += (_this.step || 1) * step;
                            setTimeout(function () {
                ...
                set: function (value) {
                    if (value != this._value) {
                        ...
                        if (value == null) {
                            ...
                            value = this._clamp(value);
                            var text = wijmo.Globalize.format(value, this.format, false, true);
                            this._setText(text);
                        }
                    }
                },
            ...
            */
            ...
            InputNumber.prototype.refresh = function (fullUpdate) {
                this._updateSymbols();
                var text = wijmo.Globalize.format(this.value, this.format, false, true);
                this._setText(text);
            };
            ...
            InputNumber.prototype._setText = function (text) {
                ...
                // handle strings composed only of decimal or currency signs (TFS 143559, 141501)
                if (text == this._decChar || text == this._currChar || this._rxSym.test(text)) {
                    text = '0';
                }
                ...
                // get formatted value
                var fval = wijmo.Globalize.format(value, fmt, false, true);
            ...
            InputNumber.prototype._clickSpinner = function (e) {
                ...
                if (this.value != null && this.step != null) {
                    // apply increment with rounding (not truncating, TFS 142618)
                    //this.value += this.step * (contains(this._btnUp, e.target) ? +1 : -1);
                    var value = this.value + this.step * (wijmo.contains(this._btnUp, e.target) ? +1 : -1), text = wijmo.Globalize.format(value, this.format, false, false);
                    this._setText(text);
                ...
                */
                ...
                set: function (value) {
                    if (value != this.value) {
                        ...
                        // (for IE consistency with typing, required to pass our unit tests...)
                        this._tbx.selectionStart = this._tbx.value.length;

                        // update masked value
                        value = this._maskProvider._applyMask();
