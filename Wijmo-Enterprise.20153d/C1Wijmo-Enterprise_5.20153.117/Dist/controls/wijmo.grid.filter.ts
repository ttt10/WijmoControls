...
module wijmo.grid.filter {
    ...
    export class FlexGridFilter {
        ...
        private _filterGlyph: HTMLElement;
        ...
        constructor(grid: FlexGrid) {
            ...
            this._filterGlyph = createElement('<div ' + FlexGridFilter._WJA_FILTER +
                    ' style ="float:' + (grid._rtl ? 'left' : 'right') + ';cursor:pointer;padding:0px 4px">' +
                    ...
                    if (cf && cf.filterType != FilterType.None) {
                        ...
                        if (this._showIcons) {
                            var cell = <HTMLElement>(e.cell.querySelector('div') || e.cell),
                                glyph = this._filterGlyph.cloneNode(true);
