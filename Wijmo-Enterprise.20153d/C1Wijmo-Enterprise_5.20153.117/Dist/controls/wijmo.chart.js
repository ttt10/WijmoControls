            ...
            FlexChartCore.prototype._render = function (engine) {
                ...
                if (w > 0 && h > 0) {
                    ...
                    for (var i = 0; i < axes.length; i++) {
                        var ax = axes[i];
                        if (ax.axisType == 0 /* X */) {
                            ax._hostElement = engine.startGroup(chart.FlexChart._CSS_AXIS_X);
                        } else {
                            ax._hostElement = engine.startGroup(chart.FlexChart._CSS_AXIS_Y);
                        }
            ...
            FlexChartCore.prototype._layoutMultiple = function (rect, size, engine) {
                ...
                for (var icol = 0; icol < ncols; icol++) {
                    ...
                    for (var i = 0; i < ad.axes.length; i++) {
                        var ax = ad.axes[i];
                        var ah = ax._getHeight(engine, ax.axisType == 0 /* X */ ? w : h);
                        if (ah > mxsz.height)
                            ah = mxsz.height;
                ...
                for (var irow = 0; irow < nrows; irow++) {
                    ...
                    for (var i = 0; i < ad.axes.length; i++) {
                        var ax = ad.axes[i];
                        var szy = new wijmo.Size(mysz.width, ax._getHeight(engine, ax.axisType == 0 /* X */ ? w : h));
                    ...
                    if (xvalues) {
                        ...
                        for (var j = 0; j < xvalues.length; j++) {
                            ...
                            if (_DataInfo.isValid(val)) {
                                ...
                                if (j > 0 && (!ctype || ctype == 0 /* Column */ || ctype == 1 /* Bar */)) {
            ...
            Axis.prototype._getHeight = function (engine, maxw) {
                ...
                if (this.labels) {
                    ...
                    if (lbls != null && lbls.length > 0) {
                        ...
                        if (angle === undefined && this.axisType == 0 /* X */) {
            ...
            */
            ...
            Axis.prototype._createMinors = function (engine, vals, isVert, isNear, isCategory) {
                if (vals && vals.length > 1) {
                    var delta = this.majorUnit ? (this._isTimeAxis ? this.majorUnit * 24 * 3600 * 1000 : this.majorUnit) : vals[1] - vals[0];
            ...
            Axis.prototype._renderLabel = function (engine, val, text, pos, ha, va, className) {
                ...
                if (text) {
                    ...
                    var hide = this.overlappingLabels == 0 /* Auto */ && this._actualAngle === undefined;
            ...
            Axis.prototype._renderRotatedLabel = function (engine, sval, lpt, labelAngle, lblClass, isNear) {
                if (sval) {
                    ...
                    _chart.FlexChart._renderRotatedText(engine, sval, lpt, ha, 1, lpt, labelAngle, lblClass);
        ...
        var SeriesBase = (function () {
            ...
            */
            ...
            SeriesBase.prototype._measureLegendItem = function (engine, text) {
                ...
                if (this._name) {
                    var tsz = engine.measureString(text, _chart.FlexChart._CSS_LABEL);
                    sz.width += tsz.width;
                    if (sz.height < tsz.height) {
                        sz.height = tsz.height;
                    }
            ...
            SeriesBase.prototype._drawLegendItem = function (engine, rect, chartType, text, style, symbolStyle) {
                ...
                if (this._name) {
                    _chart.FlexChart._renderText(engine, text, new wijmo.Point(rect.left + hsym + 2 * marg, yc), 0, 1, _chart.FlexChart._CSS_LABEL);
                }
            };
